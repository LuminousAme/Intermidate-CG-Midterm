...
//GameWinMenu.h, the header file for the class that represents the game over menu
#pragma once
...
class GameWinMenu : public TTN_Scene {
public:
	//default constructor
	GameWinMenu();
...
class GameWinMenuUI : public TTN_Scene {
public:
	//default constructor
	GameWinMenuUI();

	//default destrcutor 
	~GameWinMenuUI() = default;
...
private:
	...
	TTN_Texture2D::st2dptr textureGameWin;
